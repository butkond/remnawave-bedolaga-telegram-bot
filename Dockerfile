...
# Системный setuptools базового образа приложению не нужен (зависимости в .venv), а Trivy находит
# в его версии CVE-2025-47273 — убираем из образа.
RUN /usr/local/bin/python -m pip uninstall -y setuptools
