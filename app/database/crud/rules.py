...
1. Сервис предоставляется без каких-либо гарантий в том виде, в котором он существует.

2. Использование сервиса для незаконных действий запрещается.

3. Администрация оставляет за собой право заблокировать доступ пользователя в случае нарушения правил.

4. Возврат средств осуществляется в соответствии с действующей политикой возврата.

5. Пользователь несет полную ответственность за безопасность своего аккаунта.

6. При возникновении вопросов необходимо обращаться в техническую поддержку.

Использование сервиса означает согласие с данными правилами.
"""
